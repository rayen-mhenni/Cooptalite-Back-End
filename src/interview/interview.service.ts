...
export class InterviewService {
    ...
    async updateInterview(id: string, createInterviewDTO: CreateInterviewDTO): Promise<any> {

        const Interview = await this.InterviewModel.findById(id);

        if (Interview) {
            const newInterview = await this.InterviewModel.findByIdAndUpdate(Interview._id,
                {
                    ...
                    heureInterview: createInterviewDTO.heureInterview || Interview.heureInterview,
                    dateInterview: createInterviewDTO.dateInterview || Interview.dateInterview,
